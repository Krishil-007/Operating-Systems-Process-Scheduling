...
void greet()
{
	cout << "\n\n************************************************************************************************************" << endl;
	cout << "**                                                                                                        **" << endl;
	cout << "**                                       CPU SCHEDULING ALOGORITHMS                                       **" << endl;
	cout << "**                                                                                                        **" << endl;
	cout << "************************************************************************************************************" << endl;
}
...
void RoundRobin(Process P[], int jobCount)
{
	...
	map<int, int> id_compl;//for tracking complition
...
void FirstComeFirstServed(Process P[], int jobCount)
{
	...
	{
		P[i].setCompletionTime(max(prevEnd + P[i].getBurstTime(), P[i].getArrivalTime()) + P[i].getBurstTime());
		P[i].setTurnAroundTime(P[i].getCompletionTime() - P[i].getArrivalTime());
		P[i].setWaitingTime(P[i].getTurnAroundTime() - P[i].getBurstTime());
...
void ShortestRemainingTimeFirst(Process P[], int jobCount)
{
...
int main()
{
	...
	while (1)
	{
		...
		case 4:
		{
			ShortestRemainingTimeFirst(P, jobCount);
			break;
		}
		case 5:
		{
